...
num_trials = 5
save_prefix = 'deepstarr_distilled_aug'
save_prefix_old = 'deepstarr'  # or 'deepstarr'
...
for downsample in downsamples:
    ...
    for trial in range(num_trials):
        ...
        model = evoaug_custom.AugModel(DeepSTARR_unc, ensemble_models, input_shape=(L,A), augment_list=augment_list, 
        ...
        finetune_model = evoaug.AugModel(DeepSTARR_unc, input_shape=(L,A), augment_list=[], 
