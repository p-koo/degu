...
num_trials = 5
save_prefix = 'deepstarr_evoaug_distilled'
save_prefix_old = 'deepstarr_evoaug'
batch_size = 100
epochs = 100
...
for downsample in downsamples:
    ...
    for trial in range(num_trials):
        ...
        model = evoaug.RobustModel(DeepSTARR_unc, input_shape=(L,A), augment_list=augment_list, 
        ...
        finetune_model = evoaug.RobustModel(DeepSTARR_unc, input_shape=(L,A), augment_list=augment_list, 
                                   max_augs_per_seq=2, hard_aug=True)
